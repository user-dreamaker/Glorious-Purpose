...
{
    {TRAINER_CLASS_LEADER, 5},
    {TRAINER_CLASS_ELITE_FOUR, 10},
    {TRAINER_CLASS_PKMN_PROF, 1},
    {TRAINER_CLASS_RIVAL_EARLY, 2},
    {TRAINER_CLASS_RIVAL_LATE, 5},
    {TRAINER_CLASS_CHAMPION, 10},
    {TRAINER_CLASS_YOUNGSTER, 1},
    {TRAINER_CLASS_BUG_CATCHER, 1},
    {TRAINER_CLASS_HIKER, 1},
    {TRAINER_CLASS_BIRD_KEEPER, 1},
    {TRAINER_CLASS_PICNICKER, 1},
    {TRAINER_CLASS_SUPER_NERD, 1},
    {TRAINER_CLASS_FISHERMAN, 1},
    {TRAINER_CLASS_TEAM_ROCKET, 5},
    {TRAINER_CLASS_LASS, 1},
    {TRAINER_CLASS_BEAUTY, 1},
    {TRAINER_CLASS_BLACK_BELT, 1},
    {TRAINER_CLASS_CUE_BALL, 1},
    {TRAINER_CLASS_CHANNELER, 1},
    {TRAINER_CLASS_ROCKER, 1},
    {TRAINER_CLASS_GENTLEMAN, 1},
    {TRAINER_CLASS_BURGLAR, 1},
    {TRAINER_CLASS_SWIMMER_M, 1},
    {TRAINER_CLASS_ENGINEER, 1},
    {TRAINER_CLASS_JUGGLER, 1},
    {TRAINER_CLASS_SAILOR, 1},
    {TRAINER_CLASS_COOLTRAINER, 1},
    {TRAINER_CLASS_POKEMANIAC, 1},
    {TRAINER_CLASS_TAMER, 1},
    {TRAINER_CLASS_CAMPER, 1},
    {TRAINER_CLASS_PSYCHIC, 1},
    {TRAINER_CLASS_BIKER, 1},
    {TRAINER_CLASS_GAMER, 1},
    {TRAINER_CLASS_SCIENTIST, 1},
    {TRAINER_CLASS_CRUSH_GIRL, 1},
    {TRAINER_CLASS_TUBER, 1},
    {TRAINER_CLASS_PKMN_BREEDER, 1},
    {TRAINER_CLASS_PKMN_RANGER, 1},
    {TRAINER_CLASS_AROMA_LADY, 1},
    {TRAINER_CLASS_RUIN_MANIAC, 1},
    {TRAINER_CLASS_LADY, 1},
    {TRAINER_CLASS_PAINTER, 1},
    {TRAINER_CLASS_TWINS, 1},
    {TRAINER_CLASS_YOUNG_COUPLE, 1},
    {TRAINER_CLASS_SIS_AND_BRO, 1},
    {TRAINER_CLASS_COOL_COUPLE, 1},
    {TRAINER_CLASS_CRUSH_KIN, 1},
    {TRAINER_CLASS_SWIMMER_F, 1},
    {TRAINER_CLASS_PLAYER, 1},
    {TRAINER_CLASS_RS_LEADER, 1},
    {TRAINER_CLASS_RS_ELITE_FOUR, 1},
    {TRAINER_CLASS_RS_LASS, 1},
    {TRAINER_CLASS_RS_YOUNGSTER, 1},
    {TRAINER_CLASS_PKMN_TRAINER, 1},
    {TRAINER_CLASS_RS_HIKER, 1},
    {TRAINER_CLASS_RS_BEAUTY, 1},
    {TRAINER_CLASS_RS_FISHERMAN, 1},
    {TRAINER_CLASS_RS_LADY, 1},
    {TRAINER_CLASS_TRIATHLETE, 1},
    {TRAINER_CLASS_TEAM_AQUA, 1},
    {TRAINER_CLASS_RS_TWINS, 1},
    {TRAINER_CLASS_RS_SWIMMER_F, 1},
    {TRAINER_CLASS_RS_BUG_CATCHER, 1},
    {TRAINER_CLASS_SCHOOL_KID, 1},
    {TRAINER_CLASS_RICH_BOY, 5},
    {TRAINER_CLASS_SR_AND_JR, 1},
    {TRAINER_CLASS_RS_BLACK_BELT, 1},
    {TRAINER_CLASS_RS_TUBER_F, 1},
    {TRAINER_CLASS_HEX_MANIAC, 1},
    {TRAINER_CLASS_RS_PKMN_BREEDER, 1},
    {TRAINER_CLASS_TEAM_MAGMA, 1},
    {TRAINER_CLASS_INTERVIEWER, 1},
    {TRAINER_CLASS_RS_TUBER_M, 1},
    {TRAINER_CLASS_RS_YOUNG_COUPLE, 1},
    {TRAINER_CLASS_GUITARIST, 1},
    {TRAINER_CLASS_RS_GENTLEMAN, 1},
    {TRAINER_CLASS_RS_CHAMPION, 1},
    {TRAINER_CLASS_MAGMA_LEADER, 1},
    {TRAINER_CLASS_BATTLE_GIRL, 1},
    {TRAINER_CLASS_RS_SWIMMER_M, 1},
    {TRAINER_CLASS_POKEFAN, 1},
    {TRAINER_CLASS_EXPERT, 1},
    {TRAINER_CLASS_DRAGON_TAMER, 1},
    {TRAINER_CLASS_RS_BIRD_KEEPER, 1},
    {TRAINER_CLASS_NINJA_BOY, 1},
    {TRAINER_CLASS_PARASOL_LADY, 1},
    {TRAINER_CLASS_BUG_MANIAC, 1},
    {TRAINER_CLASS_RS_SAILOR, 1},
    {TRAINER_CLASS_COLLECTOR, 1},
    {TRAINER_CLASS_RS_PKMN_RANGER, 1},
    {TRAINER_CLASS_MAGMA_ADMIN, 1},
    {TRAINER_CLASS_RS_AROMA_LADY, 1},
    {TRAINER_CLASS_RS_RUIN_MANIAC, 1},
    {TRAINER_CLASS_RS_COOLTRAINER, 1},
    {TRAINER_CLASS_RS_POKEMANIAC, 1},
    {TRAINER_CLASS_KINDLER, 1},
    {TRAINER_CLASS_RS_CAMPER, 1},
    {TRAINER_CLASS_RS_PICNICKER, 1},
    {TRAINER_CLASS_RS_PSYCHIC, 1},
    {TRAINER_CLASS_RS_SIS_AND_BRO, 1},
    {TRAINER_CLASS_OLD_COUPLE, 1},
    {TRAINER_CLASS_AQUA_ADMIN, 1},
    {TRAINER_CLASS_AQUA_LEADER, 1},
    {TRAINER_CLASS_BOSS, 10},
    { 0xFF, 5},
};
...
static u8 GetDynamicTrainerMonLevel(u8 lvl)
{
    if (lvl == 0)
     ...
     && !(gBattleTypeFlags & (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_TRAINER_TOWER)))
    {
        ...
        for (i = 0; i < gTrainers[trainerNum].partySize; i++)
        {
            ...
            case 0:
            {
                ...
                CreateMon(&party[i], partyData[i].species, lvl, fixedIV, TRUE, personalityValue, OT_ID_RANDOM_NO_SHINY, 0);
                break;
            }
...
static void TryDoEventsBeforeFirstTurn(void)
{
    ...
    if (AbilityBattleEffects(ABILITYEFFECT_DOWNLOAD, 0, 0, 0, 0) != 0)
        return;
    if (AbilityBattleEffects(ABILITYEFFECT_FOREWARN, 0, 0, 0, 0) != 0)
        return;
    if (AbilityBattleEffects(ABILITYEFFECT_FRISK, 0, 0, 0, 0) != 0)
        return;
