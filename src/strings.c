...
const u8 gText_LevelCapPopup[] = _("LEVEL CAP\nLv{STR_VAR_2}");
const u8 gText_RareCandyLevelCapBlocked[] = _("Can't use RARE CANDY!\nLevel Cap: Lv{STR_VAR_2}{PAUSE_UNTIL_PRESS}");
