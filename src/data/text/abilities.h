...
static const u8 sPlusDescription[] = _("Powers up with MINUS or PLUS.");
static const u8 sMinusDescription[] = _("Powers up with PLUS or MINUS.");
...
static const u8 sMotorDriveDescription[] = _("Turns electricity into Speed.");
...
static const u8 sDrySkinDescription[] = _("Prefers the rain to heat.");
static const u8 sDownloadDescription[] = _("Adjusts power from foe's stats.");
